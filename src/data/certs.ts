...
export const certs: ICertificate[] = [
  {
    ...
    fecha: "2022",
    imagen: "https://images.credly.com/size/680x680/images/e8fe3d67-2967-43d0-bc4a-7a268a37f47b/image.png",
    obtenido: true
  },
  {
    id: 2,
    ...
    institucion: "Cisco",
    fecha: "2022",
    imagen: "https://images.credly.com/size/680x680/images/70d71df5-f3dc-4380-9b9d-f22513a70417/CCNAITN__1_.png",
    obtenido: true
  },
  {
    id: 6,
    titulo: "Junior Cybersecurity Analyst Career Path",
    institucion: "Cisco / Certificación Pathway",
    fecha: "2023",
    imagen: "https://images.credly.com/size/680x680/images/441578ec-c0f3-46cc-95fc-86b27e90cf4f/image.png",
    obtenido: true
  },
  {
    id: 3,
